...
## Corpus Check
- 94 files · ~161,005 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2109 nodes · 2831 edges · 98 communities (90 shown, 4 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 48 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `efc55721`
...
Cohesion: 0.05
Nodes (41): ../../entity_naming.dart, Chapter, _actionMaxWidth, _Buckets, _buildSections, _bySortOrder, chapter, child (+33 more)
...
Cohesion: 0.08
Nodes (28): ../../api/connection_failure.dart, available, build, createState, _EmptyBody, _gridColumns, _gridDelegate, _gridSpacing (+20 more)
...
Cohesion: 0.07
Nodes (33): Finder get, IconButton, package:flutter/material.dart, package:flutter_riverpod/flutter_riverpod.dart, package:flutter_test/flutter_test.dart, package:patra/l10n/generated/app_localizations.dart, package:patra/src/features/home/home_screen.dart, package:patra/src/features/reader/page_loading.dart (+25 more)
...
Cohesion: 0.07
Nodes (31): AsyncValue, ../launch/launch_animation.dart, Library, build, _cardMaxWidth, _cardSpacing, _cardWidth, columns (+23 more)
...
Cohesion: 0.08
Nodes (24): HttpClientAdapter, _DeviceAdapter, _KavitaLikeAdapter, _PageAdapter, authenticatedStatus, client, close, _FakeKavitaAdapter (+16 more)
...
Cohesion: 0.10
Nodes (19): package:patra/src/api/kavita_client.dart, package:patra/src/features/library/library_screen.dart, package:patra/src/settings/reading_settings.dart, _Adapter, client, close, fetch, main (+11 more)

### Community 30 - "Agent Docs and Triage Labels"
Cohesion: 0.27
Nodes (10): gh CLI conventions, GitHub issues as the issue tracker, PRs as a request surface flag (no), Shared issue/PR number space resolution, Triage label role mapping table, needs-info label, needs-triage label, ready-for-agent label (+2 more)
...
Cohesion: 0.11
Nodes (22): AsyncNotifier, downloads_service.dart, build, cancel, _cancelTokens, copyWith, _disposed, DownloadsNotifier (+14 more)
...
Cohesion: 0.18
Nodes (15): sessionProvider, imageCacheSizeProvider, imageCacheStoreProvider, _scan, initState, build, _pickDirection, _pickLanguage (+7 more)
...
Cohesion: 0.08
Nodes (25): DioExceptionType?, build, initialLocaleProvider, _key, languageEndonym, load, LocaleNotifier, LocaleSettingsStore (+17 more)
...
Cohesion: 0.12
Nodes (15): NavigationBar, package:patra/src/app.dart, package:patra/src/auth/session.dart, package:patra/src/downloads/downloads_provider.dart, package:patra/src/features/login/login_screen.dart, _a, _b, _container (+7 more)
...
Cohesion: 0.29
Nodes (8): docs/adr/ decision record directory, CONTEXT-MAP.md (multi-context repo marker), CONTEXT.md (glossary / domain model), Domain docs consumption protocol, /domain-modeling skill (lazy doc creation), Flag ADR conflicts rather than silently overriding, Use the glossary's vocabulary, never a synonym, Proceed silently on missing domain docs
...
Cohesion: 0.20
Nodes (12): ConsumerState, ConsumerStatefulWidget, serverReachableProvider, _EmptyLibrary, _EmptyLibraryState, build, chapterInfoProvider, ReaderScreen (+4 more)

### Community 75 - "Series Detail Providers"
Cohesion: 0.17
Nodes (16): kavitaClientProvider, save, savedChapterProvider, _Shelf, libraryTypeProvider, didChangeDependencies, _saveProgress, build (+8 more)
...
Cohesion: 0.47
Nodes (6): Native issue dependencies (blocked_by), Child ticket (GitHub sub-issue), Claim (assign @me, session's first write), Frontier query (next unblocked, unassigned child), Resolve (comment, close, append to Decisions-so-far), Wayfinder map issue
...
### Community 92 - "Server Entry and Session"
Cohesion: 0.40
Nodes (6): Server reachable over https:// or LAN http://, Thin hand-written Kavita REST client, Kavita server (v0.9+), Multiple servers with keychain tokens, Patra (Flutter Kavita client), Riverpod + go_router + dio stack
...
- `docs/adr/ decision record directory` → `Patra (Flutter Kavita client)`  [AMBIGUOUS]
  README.md · relation: conceptually_related_to

## Knowledge Gaps
- **1411 isolated node(s):** `graph`, `inRepo`, `driver`, `installed`, `null` (+1406 more)
...
- **What is the exact relationship between `docs/adr/ decision record directory` and `Patra (Flutter Kavita client)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
...
- **Why does `ADR-0001 — one-finger drag magnifies the page` connect `Magnify ADR Decisions` to `Magnify Design Space`, `Entity Naming Tests`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `docs/adr/ decision record directory` connect `Entity Naming Tests` to `Server Entry and Session`, `Magnify ADR Decisions`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **What connects `graph`, `inRepo`, `driver` to the rest of the system?**
