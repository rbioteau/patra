# Graph Report - feat-15-preferences-follow-the-person  (2026-09-07)

## Corpus Check
- 123 files · ~220,236 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2747 nodes · 3826 edges · 121 communities (110 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 30 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bb0072b8`
...
5. `sessionProvider` - 11 edges
6. `build` - 11 edges
7. `downloadsProvider` - 10 edges
8. `_ReaderScreenState` - 9 edges
...
Cohesion: 0.08
Nodes (30): sessionProvider, _ProfileFace, available, build, createState, _EmptyBody, _EmptyLibrary, _EmptyLibraryState (+22 more)
...
Cohesion: 0.04
Nodes (45): DioExceptionType?, Object?, package:flutter/widgets.dart, package:patra/l10n/generated/app_localizations_en.dart, package:patra/l10n/generated/app_localizations_fr.dart, package:patra/src/api/connection_failure.dart, package:patra/src/entity_naming.dart, package:patra/src/resume_point.dart (+37 more)
...
Cohesion: 0.09
Nodes (26): AsyncNotifier, downloads_service.dart, build, cancel, _cancelTokens, copyWith, _disposed, DownloadsNotifier (+18 more)
...
Cohesion: 0.09
Nodes (21): dart:convert, accountIdFrom, _padded, segments, package:dio/dio.dart, package:patra/src/features/library/library_screen.dart, _Adapter, client (+13 more)
...
### Community 46 - "test_support.dart"
Cohesion: 0.14
Nodes (13): package:patra/src/api/client_identity.dart, package:patra/src/settings/cache_settings.dart, package:patra/src/settings/profile_preferences.dart, package:patra/src/settings/reading_settings.dart, container, directionFor, _lea, main (+5 more)

### Community 47 - "offline_indicator_test.dart"
Cohesion: 0.08
Nodes (23): Finder get, IconButton, package:patra/src/features/home/home_screen.dart, _Adapter, close, _cloud, _explanation, fetch (+15 more)
...
Cohesion: 0.08
Nodes (23): CachedNetworkImage, package:patra/src/api/kavita_client.dart, package:patra/src/features/series/series_detail_screen.dart, cacheDir, _chapter, client, close, fetch (+15 more)

### Community 50 - "_SlotState"
Cohesion: 0.33
...
### Community 52 - "page_backdrop.dart"
Cohesion: 0.14
Nodes (13): int?, SelectedLibraryNotifier, _artwork, chapterId, _fade, _hidden, _maxAspect, page (+5 more)

### Community 53 - "return"
Cohesion: 0.11
Nodes (16): client_identity.dart, kavita_client.dart, announceDevice, identity, null, renameTarget, _key, languageEndonym (+8 more)
...
Cohesion: 0.18
Nodes (14): ConsumerState, authProvider, build, initState, LoginScreen, _LoginScreenState, build, _enter (+6 more)
...
Cohesion: 0.06
Nodes (34): package:flutter/material.dart, package:patra/l10n/generated/app_localizations.dart, package:patra/src/features/reader/page_loading.dart, package:patra/src/features/reader/thumb_strip.dart, package:patra/src/features/settings/settings_screen.dart, package:patra/src/settings/locale_settings.dart, package:patra/src/theme.dart, _Adapter (+26 more)
...
### Community 74 - "auth_test.dart"
Cohesion: 0.04
Nodes (44): DioException get, Exception, ConnectionFailure, ConnectionFailureKind, detail, from, _fromStatus, kind (+36 more)

### Community 75 - "ConsumerWidget"
Cohesion: 0.13
Nodes (24): ConsumerWidget, kavitaClientProvider, offlineProvider, save, build, ContinueHero, _Details, _LibrariesSection (+16 more)
...
### Community 93 - "resume_point.dart"
Cohesion: 0.15
...
### Community 100 - "HttpClientAdapter"
Cohesion: 0.14
Nodes (14): HttpClientAdapter, _StubAdapter, _PageAdapter, _HomeAdapter, _UnreachableAdapter, _Adapter, _Adapter, _ReaderAdapter (+6 more)

### Community 102 - "../../l10n/generated/app_localizations.dart"
Cohesion: 0.22
Nodes (7): ../auth/session.dart, ../../l10n/generated/app_localizations.dart, formatBytes, gb, mb, sizeBytes, build
...
### Community 104 - "profile_avatar.dart"
Cohesion: 0.17
...
### Community 106 - "direction_icon.dart"
Cohesion: 0.20
Nodes (9): Color, build, color, direction, DirectionIcon, paint, shouldRepaint, size (+1 more)

### Community 107 - "build"
Cohesion: 0.11
Nodes (24): ConsumerStatefulWidget, serverReachableProvider, serverVersionProvider, savedChapterProvider, imageCacheSizeProvider, imageCacheStoreProvider, build, chapterInfoProvider (+16 more)
...
Cohesion: 0.28
Nodes (9): OfflineNotifier, ReadOverridesNotifier, DefaultReadingDirectionNotifier, LocaleNotifier, MagnifyNotifier, profilePreferencesStoreProvider, ReadingDirection, Locale (+1 more)
...
### Community 116 - "_ThumbStripState"
Cohesion: 0.67
...
## Knowledge Gaps
- **1944 isolated node(s):** `XCTest`, `localeName`, `delegate`, `localizationsDelegates`, `supportedLocales` (+1939 more)
...
- **Why does `offlineProvider` connect `ConsumerWidget` to `../../l10n/generated/app_localizations.dart`, `series_detail_screen.dart`, `library_screen.dart`, `build`, `session.dart`, `offline_indicator_test.dart`, `home_screen.dart`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `AppLocalizations` connect `Localization Delegate` to `app_localizations.dart`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `_ReaderScreenState` connect `build` to `authProvider`, `ConsumerWidget`, `reader_screen.dart`, `reader_settings_sheet.dart`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
