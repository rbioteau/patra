...
## Corpus Check
- 199 files · ~429,448 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4878 nodes · 6760 edges · 185 communities (161 shown, 20 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 85 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `df8ecf38`
...
Cohesion: 0.01
Nodes (214): app_localizations_en.dart, app_localizations_fr.dart, class, aboutSectionLabel, aboutVersion, addProfile, appLanguage, appLanguageSystem (+206 more)

### Community 1 - "app_localizations_fr.dart"
Cohesion: 0.01
Nodes (201): app_localizations.dart, aboutSectionLabel, aboutVersion, addProfile, appLanguage, appLanguageSystem, appTagline, askServerToScan (+193 more)

### Community 2 - "app_localizations_en.dart"
Cohesion: 0.01
Nodes (201): aboutSectionLabel, aboutVersion, addProfile, appLanguage, appLanguageSystem, appTagline, askServerToScan, backToProfiles (+193 more)
...
Cohesion: 0.02
Nodes (125): book_contents.dart, ChapterInfo, DownloadsNotifier?, KavitaClient?, anchor, _anchorFor, _anchors, aspectRatios (+117 more)

### Community 5 - "models.dart"
Cohesion: 0.02
Nodes (92): adminRole, ageRestricted, and, apiKey, aspectRatio, aspectRatioFor, BookInfo, bookScrollId (+84 more)
...
Cohesion: 0.06
Nodes (43): ../../api/client_identity.dart, ../../downloads/image_cache_store.dart, serverReachableProvider, serverVersionProvider, imageCacheSizeProvider, imageCacheStoreProvider, actionLabel, _avatarSize (+35 more)
...
Cohesion: 0.04
Nodes (50): Chapter, ../../entity_naming.dart, boxInset, _Buckets, chapter, ChapterSort, child, clear (+42 more)
...
Cohesion: 0.03
Nodes (64): ../../api/models.dart, AsyncValue, ../../catalogue/catalogue_reads.dart, continue_hero.dart, cover.dart, ../downloads/resume_strip.dart, Library, ResolvedFailure (+56 more)
...
Cohesion: 0.06
Nodes (33): ColoredBox, FractionallySizedBox, LinearProgressIndicator, package:flutter/rendering.dart, package:patra/src/widgets/read_mark.dart, RenderParagraph, ScaffoldMessengerState, main (+25 more)

### Community 25 - "profile_lock_sheet.dart"
Cohesion: 0.06
Nodes (33): ConsumerStatefulWidget, ReaderScreen, biometricsProvider, askProfilePin, _backspace, _biometrics, build, child (+25 more)

### Community 26 - "downloads_service.dart"
Cohesion: 0.02
Nodes (85): ChapterContent get, ../features/reader/book_face.dart, ../features/reader/book_page.dart, _adoptUncommittedPages, _ambiguousQueue, batchId, bookScrollId, bytes (+77 more)
...
Cohesion: 0.06
Nodes (38): package:flutter/material.dart, package:patra/l10n/generated/app_localizations.dart, package:patra/src/features/library/library_screen.dart, package:patra/src/features/reader/thumb_strip.dart, package:patra/src/settings/locale_settings.dart, _Adapter, client, close (+30 more)

### Community 39 - "_ReaderScreenState"
Cohesion: 0.08
Nodes (36): bookLineHeightProvider, bookReadingFaceProvider, bookTextSizeProvider, chapterDirectionProvider, chapterDirProvider, downloadsProvider, imageCacheLimitProvider, kavitaClientProvider (+28 more)
...
Cohesion: 0.07
Nodes (32): ConsumerState, features/downloads/downloads_screen.dart, features/home/home_screen.dart, features/library/library_screen.dart, features/login/login_screen.dart, features/profiles/profile_picker_screen.dart, features/reader/reader_screen.dart, features/series/series_detail_screen.dart (+24 more)

### Community 44 - "reader_settings_sheet.dart"
Cohesion: 0.05
Nodes (36): ChapterDirection, direction_icon.dart, ../features/reader/reading_direction.dart, ../features/reader/strip_geometry.dart, _ActionRow, bookFamily, current, defaultValue (+28 more)
...
Cohesion: 0.04
Nodes (50): ../branding/patra_lockup.dart, double?, download_stop.dart, ../../downloads/downloads_provider.dart, ../../downloads/downloads_service.dart, EdgeInsetsGeometry, IconData, ../../l10n/generated/app_localizations.dart (+42 more)
...
### Community 53 - "package:flutter_riverpod/flutter_riverpod.dart"
Cohesion: 0.05
Nodes (44): build, report, package:flutter_riverpod/flutter_riverpod.dart, package:patra/src/api/client_identity.dart, package:patra/src/branding/patra_font_licenses.dart, package:patra/src/features/reader/reading_direction.dart, package:patra/src/features/settings/settings_screen.dart, package:patra/src/settings/cache_settings.dart (+36 more)
...
### Community 56 - "return"
Cohesion: 0.04
Nodes (61): dart:io, package:integration_test/integration_test_driver_extended.dart, package:patra/src/catalogue/catalogue_provider.dart, package:patra/src/catalogue/catalogue_store.dart, package:patra/src/downloads/downloads_provider.dart, package:patra/src/features/home/continue_hero.dart, package:patra/src/theme.dart, package:patra/src/widgets/offline_indicator.dart (+53 more)
...
Cohesion: 0.11
Nodes (16): package:flutter_test/flutter_test.dart, package:patra/src/api/kavita_client.dart, package:patra/src/api/models.dart, package:patra/src/features/reader/book_face.dart, package:patra/src/features/reader/spread_layout.dart, package:patra/src/resume_point.dart, main, main (+8 more)
...
Nodes (25): book,
  ...
  rightToLeft,, BookType, defaultBookLineHeight, defaultBookReadingFace, defaultBookTextSize, directionNamed (+17 more)
...
Cohesion: 0.05
Nodes (36): package:patra/src/features/reader/reader_screen.dart, package:patra/src/session_scope.dart, required Credential credential,
  ClientIdentity, _app, attempts, close, fetch, identity (+28 more)
...
### Community 77 - "DownloadsNotifier"
Cohesion: 0.25
...
### Community 84 - "dart:convert"
Cohesion: 0.07
Nodes (26): dart:convert, accountIdFrom, _padded, segments, package:patra/src/api/account_id.dart, package:patra/src/catalogue/catalogue_reads.dart, _jwt, main (+18 more)
...
### Community 97 - "login_screen.dart"
Cohesion: 0.03
Nodes (66): ../../api/connection_failure.dart, FormState, authProvider, Profile, Session, profileCatalogueProvider, profileDownloadsProvider, _ProfileFace (+58 more)
...
### Community 110 - "server_version_test.dart"
Cohesion: 0.11
...
### Community 114 - "connection_failure_test.dart"
Cohesion: 0.13
...
### Community 126 - "Map"
Cohesion: 0.21
Nodes (12): AppLifecycleState, OfflineNotifier, LibraryScanNotifier, BookFontsCache, PageShapesNotifier, ReadOverridesNotifier, AppLifecycleNotifier, DirectionMapNotifier (+4 more)
...
### Community 134 - "catalogue_overlay_test.dart"
Cohesion: 0.04
...
### Community 147 - "../../auth/session.dart"
Cohesion: 0.18
Nodes (10): ../../auth/session.dart, _artwork, chapterId, _fade, _hidden, _maxAspect, page, _scrim (+2 more)

### Community 152 - "ConsumerWidget"
Cohesion: 0.07
Nodes (58): catalogue, ConsumerWidget, kavitaClientProvider, offlineProvider, batchSummaryProvider, chapterDirProvider, downloadMembershipProvider, downloadRecordProvider (+50 more)

### Community 153 - "Widget"
Cohesion: 0.27
...
Cohesion: 0.04
Nodes (46): BookContentsEntry, _EmptyBody, _LibraryGridSkeleton, _LibraryPills, BookContentsButton, build, _contentsIndent, _ContentsList (+38 more)
...
### Community 164 - "deep_link_test.dart"
Cohesion: 0.06
Nodes (31): NavigationBar, package:patra/src/app.dart, package:patra/src/features/login/login_screen.dart, package:patra/src/features/series/series_detail_screen.dart, package:patra/src/routes.dart, required Directory downloadsRoot,
  bool, _app, client (+23 more)
...
Cohesion: 0.14
Nodes (16): DirectionPicked, DirectionPromotedToLibrary, LibraryDirectionCleared, ReaderSettingsOutcome, SeriesDirectionCleared, package:patra/src/settings/reading_settings.dart, package:patra/src/widgets/reader_settings_sheet.dart, _builtIn (+8 more)
...
## Knowledge Gaps
- **3545 isolated node(s):** `Status`, `Roadmap`, `Install`, `Development`, `Architecture` (+3540 more)
...
- **Why does `_` connect `_` to `login_screen.dart`, `package:flutter/material.dart`, `downloads_service_test.dart`, `List`, `String?`, `page_rail.dart`, `../theme.dart`, `home_screen.dart`, `../../auth/session.dart`, `static const`, `package:flutter_riverpod/flutter_riverpod.dart`, `downloads_screen.dart`, `ConsumerWidget`, `dart:async`, `Map`, `StatelessWidget`?**
...
- **What connects `Status`, `Roadmap`, `Install` to the rest of the system?**
