...
## Corpus Check
- 174 files · ~333,538 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3976 nodes · 5560 edges · 174 communities (150 shown, 20 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 85 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0075fe6a`
...
Cohesion: 0.02
Nodes (106): book_contents.dart, book_page.dart, anchor, _anchorFor, _anchors, aspectRatios, barHeight, BookPageKey (+98 more)
...
### Community 8 - "package:patra/src/api/kavita_client.dart"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (34): HttpClientAdapter, package:patra/src/catalogue/catalogue_overlay.dart, _BookAdapter, adapter, _AnswersThenFails, _AnswersThenHangs, calls, client (+26 more)
...
### Community 17 - "_"
Cohesion: 0.06
Nodes (37): authProvider, _, alreadyRunning, any, asked, _askForScan, available, canScan (+29 more)

### Community 18 - "home_screen.dart"
Cohesion: 0.06
Nodes (35): continue_hero.dart, Library, build, _cardMaxWidth, _cardSpacing, _cardWidth, columns, continueHeroProvider (+27 more)
...
Cohesion: 0.09
Nodes (22): _LibraryGridSkeleton, _LibraryPills, BookPageUnavailable, _BottomChrome, _ReaderError, _SettingsCog, _SpineShadow, _TapZones (+14 more)

### Community 24 - "catalogue_write_path_test.dart"
Cohesion: 0.11
...
Cohesion: 0.08
Nodes (30): Directory, ../downloads/downloads_provider.dart, ../downloads/downloads_service.dart, ../../format.dart, IconData, chapterDirProvider, downloadsProvider, SavedChapter (+22 more)
...
Cohesion: 0.07
Nodes (29): NavigationBar, package:patra/src/app.dart, package:patra/src/features/login/login_screen.dart, package:patra/src/features/profiles/profile_picker_screen.dart, package:patra/src/features/reader/reader_screen.dart, package:patra/src/routes.dart, required Directory downloadsRoot,
  bool, _app (+21 more)
...
Cohesion: 0.05
Nodes (43): Completer, Container, CustomPaint, dart:async, LoginResult, build, dotScale, markEm (+35 more)
...
Nodes (17): LibraryType? libraryType,
  Locale, package:patra/src/features/series/series_detail_screen.dart, cacheDir, _chapter, client, close, fetch, libraryType (+9 more)

### Community 40 - "downloads_provider.dart"
Cohesion: 0.08
Nodes (28): AsyncNotifier, downloads_service.dart, profileCatalogueProvider, build, cancel, _cancelTokens, copyWith, _disposed (+20 more)
...
Cohesion: 0.09
Nodes (26): features/downloads/downloads_screen.dart, features/home/home_screen.dart, features/library/library_screen.dart, features/login/login_screen.dart, features/profiles/profile_picker_screen.dart, features/reader/reader_screen.dart, features/series/series_detail_screen.dart, features/settings/settings_screen.dart (+18 more)
...
### Community 50 - "return"
Cohesion: 0.08
Nodes (25): client_identity.dart, kavita_client.dart, announceDevice, identity, null, renameTarget, models.dart, package:dio/dio.dart (+17 more)
...
Cohesion: 0.11
Nodes (19): catalogue/catalogue_provider.dart, features/launch/launch_animation.dart, auth, build, child, _container, createState, dispose (+11 more)
...
Cohesion: 0.03
Nodes (64): dart:io, ImageCacheStore, package:flutter_test/flutter_test.dart, package:patra/src/api/models.dart, package:patra/src/catalogue/catalogue_provider.dart, package:patra/src/catalogue/catalogue_store.dart, package:patra/src/downloads/image_cache_store.dart, package:patra/src/features/home/continue_hero.dart (+56 more)

### Community 59 - "test_support.dart"
Cohesion: 0.06
Nodes (33): package:patra/l10n/generated/app_localizations.dart, package:patra/src/features/settings/settings_screen.dart, package:patra/src/settings/locale_settings.dart, _Adapter, client, close, fetch, main (+25 more)
...
Cohesion: 0.18
Nodes (17): libraryNameProvider, _BookPage, bookPageProvider, build, _buildReader, chapterInfoProvider, _ReaderScreenState, chapterDirectionProvider (+9 more)
...
Cohesion: 0.13
Nodes (32): catalogue, ConsumerWidget, kavitaClientProvider, offlineProvider, savedChapterProvider, build, ContinueHero, _Details (+24 more)
...
Cohesion: 0.06
Nodes (32): package:patra/src/api/client_identity.dart, package:patra/src/auth/session.dart, package:patra/src/lock/biometrics.dart, package:patra/src/lock/profile_lock.dart, package:patra/src/settings/cache_settings.dart, lea, main, _profile (+24 more)
...
### Community 86 - "../theme.dart"
Cohesion: 0.12
Nodes (16): Color, build, color, height, paint, PatraMark, shouldRepaint, _wordBounds (+8 more)
...
### Community 97 - "Widget"
Cohesion: 0.16
Nodes (13): ../../branding/patra_launch.dart, ConsumerState, ConsumerStatefulWidget, child, createState, LaunchAnimation, _LaunchAnimationState, play (+5 more)
...
Cohesion: 0.17
Nodes (11): _artwork, build, chapterId, _fade, _hidden, _maxAspect, page, _scrim (+3 more)
...
Cohesion: 0.06
Nodes (31): CachedNetworkImage, package:patra/src/theme.dart, package:patra/src/widgets/cover.dart, package:patra/src/widgets/cover_placeholder.dart, _channelGap, client, main, pumpCover (+23 more)

### Community 112 - "Profile lock (lib/src/lock/profile_lock.dart)"
Cohesion: 0.22
...
### Community 126 - "entity_naming.dart"
Cohesion: 0.15
...
### Community 134 - "package:flutter/foundation.dart"
Cohesion: 0.40
...
Cohesion: 0.12
Nodes (16): Future, package:patra/src/downloads/downloads_provider.dart, ProviderContainer, adapter, _chapter, close, container, fetch (+8 more)
...
### Community 151 - "ReaderSettingsOutcome"
Cohesion: 0.40
Nodes (5): DirectionPicked, DirectionPromotedToLibrary, LibraryDirectionCleared, ReaderSettingsOutcome, SeriesDirectionCleared

### Community 152 - "static const"
Cohesion: 0.09
Nodes (22): ../keychain.dart, delete, Keychain, keychainProvider, read, readAll, SecureKeychain, _storage (+14 more)

### Community 153 - "dart:convert"
Cohesion: 0.20
...
Cohesion: 0.11
Nodes (15): ../branding/patra_mark.dart, ../../l10n/generated/app_localizations.dart, formatBytes, gb, mb, sizeBytes, build, OfflineIndicator (+7 more)
...
### Community 157 - "profile_avatar.dart"
Cohesion: 0.17
...
Cohesion: 0.05
Nodes (40): DioExceptionType?, Object?, package:patra/l10n/generated/app_localizations_en.dart, package:patra/l10n/generated/app_localizations_fr.dart, package:patra/src/api/connection_failure.dart, package:patra/src/entity_naming.dart, _Adapter, body (+32 more)

### Community 159 - "library_scan_test.dart"
Cohesion: 0.10
...
Cohesion: 0.10
Nodes (20): package:patra/src/features/reader/reading_direction.dart, package:patra/src/settings/profile_preferences.dart, package:patra/src/settings/reading_settings.dart, package:patra/src/widgets/reader_settings_sheet.dart, Profile? active,
  Map, _builtIn, libraryName, main (+12 more)
...
## Knowledge Gaps
- **2792 isolated node(s):** `XCTest`, `localeName`, `delegate`, `localizationsDelegates`, `supportedLocales` (+2787 more)
...
- **Why does `_` connect `_` to `api/models.dart`, `continue_hero.dart`, `package:flutter/material.dart`, `profile_picker_screen.dart`, `String?`, `chrome_pill.dart`, `page_rail.dart`, `app.dart`, `../auth/session.dart`, `ConsumerWidget`, `home_screen.dart`, `List`, `../theme.dart`, `StatelessWidget`, `static const`, `../../l10n/generated/app_localizations.dart`, `downloads_screen.dart`, `package:flutter_riverpod/flutter_riverpod.dart`?**
