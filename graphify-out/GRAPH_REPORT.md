# Graph Report - worktree-brave-field-b050  (2026-09-16)

## Corpus Check
- 177 files · ~344,523 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4090 nodes · 5719 edges · 168 communities (147 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 85 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9fb3356b`
...
### Community 9 - "dart:convert"
Cohesion: 0.05
Nodes (35): dart:convert, accountIdFrom, _padded, segments, package:patra/src/api/account_id.dart, package:patra/src/features/settings/settings_screen.dart, _Adapter, client (+27 more)
...
Cohesion: 0.06
Nodes (36): BookContentsEntry, _EmptyBody, _LibraryGridSkeleton, BookContentsButton, build, _contentsIndent, _ContentsList, depth (+28 more)

### Community 24 - "return"
Cohesion: 0.05
Nodes (45): package:patra/src/api/client_identity.dart, package:patra/src/auth/session.dart, package:patra/src/features/reader/reading_direction.dart, package:patra/src/lock/biometrics.dart, package:patra/src/lock/profile_lock.dart, package:patra/src/settings/cache_settings.dart, package:patra/src/settings/reading_settings.dart, Profile? active,
  Map (+37 more)
...
Cohesion: 0.12
Nodes (15): CustomPainter, _LaunchPainter, build, color, height, _MarkPainter, paint, PatraMark (+7 more)

### Community 34 - "deep_link_test.dart"
Cohesion: 0.07
Nodes (28): NavigationBar, package:patra/src/app.dart, package:patra/src/downloads/downloads_provider.dart, package:patra/src/features/login/login_screen.dart, package:patra/src/features/reader/reader_screen.dart, package:patra/src/routes.dart, required Directory downloadsRoot,
  bool, _app (+20 more)
...
Cohesion: 0.05
Nodes (39): CachedNetworkImage, CustomPaint, LoginResult, Opacity, package:cached_network_image/cached_network_image.dart, package:patra/src/api/kavita_client.dart, package:patra/src/branding/patra_mark.dart, package:patra/src/features/profiles/profile_picker_screen.dart (+31 more)
...
Cohesion: 0.05
Nodes (46): direction_icon.dart, ../features/reader/reading_direction.dart, ../features/reader/strip_geometry.dart, _ActionRow, current, defaultValue, direction, DirectionPicked (+38 more)
...
### Community 50 - "series_hero_test.dart"
Cohesion: 0.11
...
Cohesion: 0.05
Nodes (42): Image, ImageInfo, ImageProvider, auth, cacheLimit, catalogue, identity, imageCache (+34 more)
...
Cohesion: 0.03
Nodes (65): dart:io, ImageCacheStore, package:flutter_test/flutter_test.dart, package:patra/src/api/models.dart, package:patra/src/catalogue/catalogue_provider.dart, package:patra/src/catalogue/catalogue_reads.dart, package:patra/src/catalogue/catalogue_store.dart, package:patra/src/downloads/downloads_service.dart (+57 more)
...
### Community 77 - "../../l10n/generated/app_localizations.dart"
Cohesion: 0.12
...
Cohesion: 0.12
Nodes (28): catalogue, ConsumerWidget, kavitaClientProvider, downloadsProvider, savedChapterProvider, _store, syncPendingProgress, DownloadsScreen (+20 more)
...
### Community 82 - "connection_failure_test.dart"
Cohesion: 0.13
...
### Community 84 - "page_shape_test.dart"
Cohesion: 0.13
...
### Community 104 - "../auth/session.dart"
Cohesion: 0.18
Nodes (12): ../auth/session.dart, offlineProvider, chapterDirProvider, build, _SavedRow, _ErrorState, _storedBookPage, build (+4 more)
...
Cohesion: 0.05
Nodes (42): build, dotScale, markEm, PatraWordmark, size, _tracking, package:flutter/material.dart, package:patra/l10n/generated/app_localizations.dart (+34 more)
...
### Community 114 - "chrome_pill.dart"
Cohesion: 0.18
...
Cohesion: 0.10
Nodes (19): Future, adapter, _chapter, close, container, dir, fetch, gate (+11 more)
...
### Community 146 - "../theme.dart"
Cohesion: 0.25
Nodes (7): ../branding/patra_lockup.dart, build, _gateGapEm, PatraMasthead, showTagline, _size, ../theme.dart
...
### Community 161 - "UserDto.isAdmin (role read from the login response)"
Cohesion: 0.47
...
### Community 164 - "gen_app_icons.sh"
Cohesion: 0.47
...
## Knowledge Gaps
- **2891 isolated node(s):** `XCTest`, `localeName`, `delegate`, `localizationsDelegates`, `supportedLocales` (+2886 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 3145 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
...
- **Why does `_` connect `_` to `api/models.dart`, `catalogue_overlay.dart`, `package:flutter_riverpod/flutter_riverpod.dart`, `../auth/session.dart`, `resume_point.dart`, `catalogue_provider.dart`, `catalogue_reads.dart`, `profile_avatar.dart`, `home_screen.dart`, `return`?**
