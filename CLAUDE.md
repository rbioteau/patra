...
- Serif (`PatraText.serifTitle`, Source Serif 4) is only for titles of works, the wordmark, and reader page numerals. Everything else is Space Grotesk. Both faces are **bundled** (`assets/fonts/`, variable, one file per family) and never fetched: a reader is opened on a train.
